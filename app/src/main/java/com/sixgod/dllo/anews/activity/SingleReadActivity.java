 ...
 */
public class SingleReadActivity extends BaseActivity{
            ...
            public void onResponse(JSONObject response) {
                try {
                 ...
                 data = new Gson().fromJson(o.toString(),SingleReadData.class);
                    ...
                    if (body==null){
                        Toast.makeText(SingleReadActivity.this, "正在维护中请浏览其他", Toast.LENGTH_SHORT).show();
                    ...
                    for (int i = 0; i <content.length ; i++) {
                        ...
                        rv.setLayoutManager(new LinearLayoutManager(SingleReadActivity.this));
